...
export const FinanceTemplate01HeroSection = ({ 
    config, 
    themeMode,
    featuredPost,
    sidePosts 
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="mt-4">
                            {featuredPost.category && (
                                <p className="text-sm font-semibold uppercase tracking-wider" style={metaStyle}>
                                    {featuredPost.category}
                                </p>
                            )}
                            ...
                            <p className="mt-4 text-muted-foreground" style={metaStyle}>
