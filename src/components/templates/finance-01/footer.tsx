...
export const FinanceTemplate01Footer = ({ config, themeMode }: { config?: TemplateConfig; themeMode?: 'light' | 'dark' }) => {
            ...
            <div className="container mx-auto px-4 md:px-6">
                 <div className="py-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div>
                         ...
                         <p className="text-muted-foreground mb-6" style={{color: colors?.textColor}}>{footerConfig.newsletterDescription || 'Get the latest financial news, market analysis, and investment tips delivered to your inbox.'}</p>
                    </div>
