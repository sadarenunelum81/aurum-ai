...
import { FoodLatestPostsGrid } from '@/components/templates/food-01/latest-posts-grid';
import { FoodCategoriesSection } from '@/components/templates/food-01/categories-section';
import { FoodDualSystemSection } from '@/components/templates/food-01/dual-system-section';
import { FoodRecentPostsSection } from '@/components/templates/food-01/recent-posts-section';
...
export const FoodTemplate01 = async ({ config, theme }: { config: TemplateConfig, theme: 'light' | 'dark' }) => {
    ...
    return (
        <div className="bg-background font-body">
            ...
            <FoodTemplate01Footer config={config} themeMode={theme} />
