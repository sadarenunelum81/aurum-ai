...
import { SportsTemplate01Header } from '@/components/templates/sports-01/header';
import { SportsTemplate01HeroSection } from '@/components/templates/sports-01/hero-section';
import { SportsLatestPostsGrid } from '@/components/templates/sports-01/latest-posts-grid';
import { SportsCategoriesSection } from '@/components/templates/sports-01/categories-section';
import { SportsDualSystemSection } from '@/components/templates/sports-01/dual-system-section';
import { SportsRecentPostsSection } from '@/components/templates/sports-01/recent-posts-section';
import { SportsTemplate01Footer } from '@/components/templates/sports-01/footer';
...
export const SportsTemplate01 = async ({ config, theme }: { config: TemplateConfig, theme: 'light' | 'dark' }) => {
    ...
    return (
        <div className="bg-background font-body">
            ...
            <SportsTemplate01Footer config={config} themeMode={theme} />
