...
// This is a placeholder for the Sports Template Hero Section.
// You can start building your unique hero component here.
...
export const SportsTemplate01HeroSection = ({ 
    config, 
    themeMode,
    featuredPost,
    sidePosts 
                ...
                <div className="grid lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div className="bg-card p-4 rounded-lg shadow-sm" style={{backgroundColor: colors?.textBoxOverlayColor}}>
                         <h3 className="font-bold text-lg mb-4 flex items-center gap-2" style={{color: colors?.titleColor}}>
                            ...
                            {heroConfig.scoresTitle || 'Top Games'}
                        </h3>
